...
int main(void)
{
  ...
  Lcd_cursor(&lcd,0,1);
  Lcd_string(&lcd,"S.Jaiganesh");
  Lcd_cursor(&lcd,1,1);
  Lcd_string(&lcd,"212222240037");
  /* Infinite loop */
...
![Screenshot (18)](https://github.com/user-attachments/assets/2388c8d4-30b2-41da-a595-4073ff5671a4)


 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![image](https://github.com/user-attachments/assets/24b33220-1942-4295-8749-d58206176e3d)
